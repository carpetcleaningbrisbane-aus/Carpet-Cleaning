  ...
  return (
    <div className="pt-24 md:pt-32 pb-24 bg-white">
      ...
      <section className="px-5 md:px-16 max-w-[1280px] mx-auto py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="order-2 lg:order-1">
            ...
            <h2 className="font-display font-bold text-3xl md:text-5xl text-[#082B59] mb-8 leading-tight">
              A Structured Approach to Every Job
            </h2>
            <p className="text-base text-[#082B59]/80 mb-6 leading-relaxed text-lg">
            ...
            <p className="text-base text-[#082B59]/80 mb-10 leading-relaxed text-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {TAGS.map((item, i) => (
                <div key={i} className="flex items-center gap-3 px-5 py-3.5 rounded-xl bg-[#F2F8FC] border border-[#1261A0]/20 shadow-sm">
                  <CheckCircle2 className="w-5 h-5 text-[#1261A0] shrink-0" />
                  <span className="text-sm font-semibold text-[#082B59]">{item}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="lg:hidden mb-4">
              <div className="bg-white rounded-xl p-4 shadow-md border border-[#1261A0]/20 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#1261A0] flex items-center justify-center">
                  <CheckCircle2 className="w-5 h-5 text-white" />
                </div>
                <div>
                  <p className="text-xs font-bold text-[#082B59] uppercase tracking-wider">Professional Grade</p>
                  <p className="text-sm font-semibold text-[#082B59]">Inspection & Assessment</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              <div className="relative h-[400px] md:h-[550px] rounded-2xl overflow-hidden shadow-xl border border-[#1261A0]/20 bg-white">
                <img
                ...
                <div className="hidden lg:flex absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-[#1261A0]/20 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#1261A0] flex items-center justify-center">
                    <CheckCircle2 className="w-5 h-5 text-white" />
                  </div>
                  <div>
      ...
      <section className="bg-[#F2F8FC] py-28 px-5 md:px-16 border-y border-[#1261A0]/15">
        <div className="max-w-[1280px] mx-auto">
          <div className="text-center mb-20">
            ...
            <h2 className="font-display font-bold text-3xl md:text-5xl text-[#082B59] mb-6">
              Our 4-Step Cleaning Process
            </h2>
            <p className="text-base text-[#082B59]/80 max-w-2xl mx-auto text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {PROCESS_STEPS.map((item, i) => (
              <div key={i} className="group relative bg-white p-8 rounded-2xl border border-[#1261A0]/20 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
                {/* Background Number */}
                <span className="font-display font-bold text-6xl text-[#F2F8FC] absolute top-4 right-6 select-none group-hover:scale-110 group-hover:text-[#1261A0]/15 transition-all duration-500">
                  {item.step}
                </span>

                <div className="w-14 h-14 rounded-xl bg-[#00B8D9] flex items-center justify-center mb-6 text-white shadow-sm group-hover:bg-[#082B59] transition-colors duration-300 relative z-10">
                  <CheckCircle2 className="w-7 h-7" />
                </div>

                <h3 className="font-display font-bold text-xl text-[#082B59] mb-3 relative z-10">{item.title}</h3>
                <p className="text-sm text-[#082B59]/80 leading-relaxed relative z-10">{item.desc}</p>

                {/* Blue bottom bar animation */}
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-[#1261A0] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white py-28 px-5 md:px-16">
        <div className="max-w-[1280px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {FEATURES.map((item, i) => (
              <div key={i} className="group bg-[#F2F8FC] p-8 rounded-2xl border border-[#1261A0]/15 hover:border-[#00B8D9]/30 transition-all duration-300 hover:shadow-md hover:-translate-y-1">
                <div className="flex gap-6 items-start">
                  <div className="w-14 h-14 shrink-0 rounded-xl bg-[#082B59] flex items-center justify-center text-white shadow-sm group-hover:bg-[#00B8D9] transition-colors duration-300">
                    <item.icon className="w-7 h-7" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-display font-bold text-xl text-[#082B59] mb-3">{item.title}</h3>
                    <p className="text-sm text-[#082B59]/80 leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="px-5 md:px-16 max-w-[1280px] mx-auto py-20">
        <div className="relative bg-[#082B59] rounded-3xl p-12 md:p-20 overflow-hidden text-center shadow-2xl">
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="w-24 h-1.5 bg-[#1261A0] mx-auto rounded-full"></div>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 md:px-16 max-w-[1280px] mx-auto py-16 text-center">
        <div className="bg-[#F2F8FC] rounded-3xl p-12 md:p-20 border border-[#1261A0]/20">
          <div className="max-w-2xl mx-auto">
            <div className="w-16 h-16 rounded-2xl bg-[#082B59] flex items-center justify-center mx-auto mb-8 shadow-lg">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-3 px-10 py-4 bg-[#082B59] text-white font-bold rounded-xl hover:bg-[#00B8D9] transition-colors duration-300 shadow-lg hover:shadow-xl group"
            >
