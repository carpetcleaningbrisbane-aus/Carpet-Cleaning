...
const CARPET_SERVICES = [
  {
    ...
    description:
      "Hot water extraction that gets into the fibres and pulls out the dirt, dust and allergens your vacuum can't reach.",
    image: imgSteam,
  },
  {
    id: "stain-removal",
    ...
    description:
      "Pet accidents, wine, coffee, mud — we treat the stain and the smell, not just the surface.",
    image: imgStain,
  },
  {
    id: "end-of-lease",
    ...
    description:
      "Moving out? We clean to real estate inspection standard so you get your bond back without a fight.",
    image: imgLease,
  },
  {
    ...
    description:
      "For heavily soiled carpets that need more than a standard steam — deep agitation followed by full extraction.",
    image: imgShampoo,
  },
  {
    id: "commercial",
    ...
    description:
      "Office, retail or reception — we work around your hours and leave the place looking sharp.",
    image: imgCommercial,
  },
  {
    id: "water-extraction",
    ...
    description:
      "Flooded or water-damaged carpet? We extract the moisture fast to prevent lasting damage and mould.",
    image: imgExtraction,
  },
];
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
              ...
              <div className="order-2 lg:order-1 flex flex-col justify-center hero-pattern relative">
                ...
                <div className="relative z-10 py-4">
                  ...
                  <p className="text-base md:text-lg text-[#082B59]/80 mb-8 max-w-xl leading-relaxed">
                    {" "}
                    Dirty carpets are more than just an eyesore. We use
                    professional hot water extraction to pull out the dirt,
                    stains and allergens that vacuuming leaves behind — leaving
                    your carpets clean, fresh and fast-drying.{" "}
                  </p>{" "}
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-10 pt-8 border-t border-[#1261A0]/20">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-semibold text-[#082B59]">
                        Deep Extraction
                      </span>{" "}
                    </div>{" "}
                    <div className="flex items-center gap-2">
        ...
        {/* 2. Why Professional Carpet Cleaning - Navy Break */}{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-[#0A3670] backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-[#1261A0]/30 shadow-2xl">
              ...
              <div>
                ...
                <h2 className="font-display font-bold text-3xl md:text-4xl text-white mb-6 leading-tight">
                  {" "}
                  Why Professional Carpet Cleaning in Brisbane?{" "}
                </h2>{" "}
                <p className="text-base text-white/80 mb-6 leading-relaxed">
                  {" "}
                  Brisbane's busy lifestyle, warm climate and everyday foot
                  traffic can quickly leave carpets looking tired and worn.
                  Professional carpet cleaning goes beyond regular vacuuming to
                  remove dirt, stains and allergens trapped deep in the
                  fibres.{" "}
                </p>{" "}
                <p className="text-sm font-semibold text-white mb-4">
                  Professional cleaning helps remove:
                </p>{" "}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  {[
                    ...
                    "Unpleasant odours",
                    "Heavy traffic marks",
                    "Dull, tired-looking carpets",
                    "Water-affected areas",
                    "Rental & end-of-lease dirt",
                    "Office & commercial grime",
                  ].map((item, idx) => (
        ...
        {/* 3. Our Carpet Cleaning Services - White */}{" "}
          ...
          <div className="px-5 md:px-16 max-w-[1280px] mx-auto py-24 md:py-32">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-base text-[#082B59]/70 max-w-2xl mx-auto">
                {" "}
                From a single room to a full commercial fit-out — we clean
                carpets the right way, every time.{" "}
              </p>{" "}
            </div>{" "}
        ...
        {/* 4. From Booking To Fresh Carpets - Navy */}
        <section className="bg-[#082B59]">
          <div className="px-5 md:px-16 max-w-[1280px] mx-auto py-24 md:py-32">
            <div className="text-center mb-14">
              <span className="inline-block px-4 py-1.5 bg-[#159A9C] text-white text-xs font-bold uppercase tracking-widest rounded-full mb-5">
                Simple Process
              </span>
              <h2 className="font-display font-bold text-3xl md:text-4xl text-white mb-4">
                From Booking To Fresh Carpets
              </h2>
              <p className="text-base text-white/65 max-w-lg mx-auto">
                A straightforward process designed to make your cleaning
                appointment easy.
              </p>
            </div>
              ...
              {[
                {
                  num: "1",
                  title: "Book",
                  desc: "Choose your service and request your preferred appointment.",
                },
                {
                  num: "2",
                  title: "We Confirm",
                  desc: "We confirm the booking details and answer any questions.",
                },
                {
                  num: "3",
                  title: "We Clean",
                  desc: "Our cleaner arrives with professional equipment and gets to work.",
                },
                {
                  num: "4",
                  title: "Enjoy",
                  desc: "Inspect the finished result and enjoy a fresher-looking space.",
                },
              ].map((step) => (
                <div
                  key={step.num}
                  className="bg-[#0A3670] rounded-2xl p-6 border border-[#1261A0]/30"
                >
                  <div className="w-9 h-9 rounded-full bg-[#159A9C] text-white text-sm font-bold flex items-center justify-center mb-5">
                    {step.num}
                  </div>
        ...
        {/* 5. Professional Steam Carpet Cleaning - Light Blue */}{" "}
          ...
          <div className="px-5 md:px-16 max-w-[1280px] mx-auto py-24 md:py-32">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12">
              ...
              <div className="max-w-2xl">
                ...
                <p className="text-base text-[#082B59]/80 leading-relaxed">
                  {" "}
                  We use hot water extraction — the industry standard for a
                  reason. Heated water and a cleaning agent go deep into the
                  carpet, then get pulled straight back out along with whatever
                  was in there. No residue, no wet carpet smell, dries in a few
                  hours.{" "}
                </p>{" "}
              </div>{" "}
              <Link
            ...
            <div className="group relative h-[320px] md:h-[400px] rounded-2xl overflow-hidden border border-[#E2EDF6] ambient-shadow mb-8">
              ...
              <div className="absolute inset-0 flex items-center px-7 md:px-12">
                ...
                <div className="max-w-md">
                  ...
                  <p className="hidden md:block text-white/85 text-sm leading-relaxed mb-5">
                    {" "}
                    Heated water and eco-safe solution loosen deep-set grime,
                    then high-power suction pulls dirt, moisture and allergens
                    straight out of the pile.{" "}
                  </p>{" "}
                  <Link
                    href="/book-now"
              ...
              <div className="absolute bottom-5 right-5 hidden lg:flex gap-3">
                ...
                {[
                  ...
                  <div
                    key={c.label}
                    className="bg-[#082B59]/60 border border-[#00B8D9]/30 backdrop-blur-md rounded-lg px-3.5 py-2 text-center"
                  >
                    {" "}
                    <p className="text-white font-display font-bold text-base leading-none">
                      {c.val}
                    </p>{" "}
                    <p className="text-white/75 text-[10px] font-semibold uppercase tracking-wider mt-0.5">
                      {c.label}
                    </p>{" "}
                  </div>
                ))}{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="relative overflow-hidden bg-white rounded-2xl border border-[#E2EDF6] ambient-shadow p-7 flex flex-col gap-5 group hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                {" "}
                <span className="absolute top-6 right-7 font-display font-bold text-4xl text-[#082B59]/5 group-hover:text-[#1261A0]/15 transition-colors duration-300 select-none">
                  01
                </span>{" "}
                <div>
                  {" "}
                  <div className="w-10 h-[3px] bg-[#1261A0] rounded-full mb-4" />{" "}
                  <h3 className="font-display font-bold text-lg text-[#082B59]">
                    What It Treats
                  </h3>{" "}
                </div>{" "}
                <ul className="space-y-2.5">
                  ...
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-2.5 text-sm text-[#082B59]"
                    >
                      {" "}
              ...
              <div className="relative overflow-hidden bg-white rounded-2xl border border-[#E2EDF6] ambient-shadow p-7 flex flex-col gap-5 group hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-sm text-[#082B59]/80 leading-relaxed">
                  {" "}
                  The cleaning process is adapted to carpet condition, fibre
                  type, and soiling level — ensuring a thorough result without
                  overwetting or damaging delicate pile.{" "}
                </p>{" "}
                <div className="mt-auto p-4 bg-[#F2F8FC] rounded-xl border border-[#E2EDF6]">
                  {" "}
                  <p className="text-xs text-[#082B59]/70 leading-relaxed">
                    {" "}
                    Careful preparation ensures consistent results. Every job is
                    assessed on-site before work begins.{" "}
                  </p>{" "}
                </div>{" "}
              </div>{" "}
              <div className="relative overflow-hidden bg-white rounded-2xl border border-[#E2EDF6] ambient-shadow p-7 flex flex-col gap-5 group hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {[
                    ...
                    { label: "Hot water extraction", val: "✓" },
                    { label: "Safe for kids & pets", val: "✓" },
                  ].map((stat) => (
                    <div
                      key={stat.label}
                      className="flex items-center justify-between py-3 border-b border-[#E2EDF6] last:border-0 last:pb-0"
                    >
                      {" "}
                      <span className="text-sm text-[#082B59]/80">
                        {stat.label}
                      </span>{" "}
                      <span className="text-base font-bold text-[#082B59]">
                        {stat.val}
                      </span>{" "}
                    </div>
                  ))}{" "}
        ...
        <section className="bg-[#FFFFFF]">
          ...
          <div className="px-5 md:px-16 max-w-[1280px] mx-auto py-24 md:py-32">
            ...
            <div className="text-center mb-12">
              {" "}
              <span className="text-xs font-bold uppercase tracking-widest text-[#1261A0] mb-2 block">
                Who We Clean For
              </span>{" "}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="group relative overflow-hidden rounded-3xl border border-[#E2EDF6] bg-[#F2F8FC] ambient-shadow flex flex-col">
                ...
                <div className="p-8 md:p-10 flex flex-col flex-grow">
                  ...
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      {" "}
                      <p className="text-[10px] font-bold uppercase tracking-widest text-[#1261A0]">
                        Home
                      </p>{" "}
                      <h3 className="font-display font-bold text-xl text-[#082B59] leading-tight">
                  ...
                  <p className="text-sm text-[#082B59]/80 leading-relaxed mb-6">
                    {" "}
                    From living rooms to hallways and stairs, carpets gradually
                    darken in high-traffic areas. Our residential service brings
                    life back to every room in your home.{" "}
                  </p>{" "}
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 mb-8">
                    ...
                    {[
                      ...
                      <div
                        key={item}
                        className="flex items-center gap-2 text-xs text-[#082B59]"
                      >
                        {" "}
              ...
              <div className="group relative overflow-hidden rounded-3xl border border-[#E2EDF6] bg-[#F2F8FC] ambient-shadow flex flex-col">
                ...
                <div className="p-8 md:p-10 flex flex-col flex-grow">
                  ...
                  <p className="text-sm text-[#082B59]/80 leading-relaxed mb-6">
                    {" "}
                    Homes with children and pets demand more from their carpets.
                    We give extra attention to stubborn stains and odours —
                    leaving carpets fresh and safe for the whole family.{" "}
                  </p>{" "}
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 mb-8">
                    {" "}
                    {[
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 md:p-12 lg:p-14 flex flex-col justify-center">
                  ...
                  <p className="text-base text-[#082B59]/80 leading-relaxed mb-8">
                    {" "}
                    Clean carpets make a noticeable difference in offices and
                    commercial environments. Reception areas, hallways and
                    meeting rooms quickly accumulate dirt — we restore them to a
                    professional standard with minimal disruption.{" "}
                  </p>{" "}
                  <div className="grid grid-cols-2 gap-3 mb-8">
                    ...
                    {[
                      ...
                      <div
                        key={item}
                        className="flex items-center gap-2 text-sm text-[#082B59]"
                      >
                        {" "}
                  ...
                  <p className="text-xs text-[#082B59]/60 mb-8 leading-relaxed">
                    {" "}
                    Appointments can be arranged around your business operating
                    hours to minimise workplace downtime.{" "}
                  </p>{" "}
                  <Link
                    href="/book-now"
                    ...
                    {[
                      {
                        ...
                        desc: "Assessing material, fibre type and condition.",
                      },
                      {
                        step: "2",
                        title: "Stain & Problem Identification",
                        desc: "Pinpointing traffic marks and specific stains.",
                      },
                      {
                        step: "3",
                        title: "Pre-Vacuuming",
                        desc: "Lifting dry surface soils and loose debris.",
                      },
                      {
                        step: "4",
                        title: "Pre-Treatment Application",
                        desc: "Eco-friendly solutions loosen embedded grime.",
                      },
                      {
                        step: "5",
                        title: "Professional Steam Cleaning",
                        desc: "Deep hot water agitation across carpet fibres.",
                      },
                      {
                        step: "6",
                        title: "Hot Water Extraction",
                        desc: "High-power suction removes moisture and dirt.",
                      },
                      {
                        step: "7",
                        title: "Stain & Odour Treatment",
                        desc: "Targeted spot neutralisation for residual marks.",
                      },
                      {
                        step: "8",
                        title: "Final Quality Inspection",
                        desc: "Ensuring pristine results and client satisfaction.",
                      },
                    ].map((s, i) => (
                      <div key={s.step} className="flex items-start gap-4">
                        ...
                        <div className="relative shrink-0">
                          ...
                          {i < 7 && (
                            <div className="absolute left-1/2 -translate-x-1/2 top-8 w-px h-4 bg-[#E2EDF6]" />
                          )}{" "}
                        </div>{" "}
                        <div className="pb-1">
                          {" "}
                          <h4 className="text-sm font-bold text-[#082B59]">
                            {s.title}
                          </h4>{" "}
                          <p className="text-xs text-[#082B59]/60 mt-0.5">
                            {s.desc}
                          </p>{" "}
                        </div>{" "}
                      </div>
          ...
          <div className="px-5 md:px-16 max-w-[1280px] mx-auto py-24 md:py-32">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-base text-[#082B59]/70 max-w-xl mx-auto">
                {" "}
                Real feedback from local Brisbane homeowners and businesses who
                trust us with their carpet & upholstery care.{" "}
              </p>{" "}
            </div>{" "}
            <TestimonialMarquee />{" "}
          </div>{" "}
        ...
        {/* 9. Service Area Map */}{" "}
        <section className="px-5 md:px-16 max-w-[1280px] mx-auto py-24 md:py-32">
          {" "}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-sm text-[#60727F] leading-relaxed mb-6">
                {" "}
                We cover Brisbane City and surrounding suburbs. Not sure if we
                service your area? Send us a message and we'll get back to
                you.{" "}
              </p>{" "}
              <div className="space-y-3 mb-8">
                ...
                {[
                  ...
                  <div
                    key={area}
                    className="flex items-center gap-2.5 text-sm text-[#102A3A]"
                  >
                    {" "}
            ...
            <div className="lg:col-span-2 rounded-2xl overflow-hidden border border-[#D6E8E8] ambient-shadow">
              {" "}
              <iframe
            ...
            <div className="bg-[#1261A0] text-white rounded-3xl p-10 md:p-16 text-center relative overflow-hidden shadow-2xl border border-[#00B8D9]/30">
              ...
              <div className="relative z-10 max-w-2xl mx-auto">
                ...
                <p className="text-base md:text-lg text-white/90 mb-8 leading-relaxed">
                  {" "}
                  Book online in a couple of minutes. No upfront payment, no
                  fuss.{" "}
                </p>{" "}
