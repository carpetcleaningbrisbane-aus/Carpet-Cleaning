...
export default function PrivacyPage() {
  return (
    <div className="pt-24 md:pt-32 pb-24 px-5 md:px-16 max-w-[960px] mx-auto">
      <h1 className="font-display font-bold text-4xl text-[#0B253A] mb-6">Privacy Policy</h1>
      ...
      <div className="space-y-6 text-sm text-[#102A3A] leading-relaxed">
        ...
        <h2 className="font-display font-bold text-xl text-[#0B253A] pt-4">1. Information We Collect</h2>
        <p>
        ...
        <h2 className="font-display font-bold text-xl text-[#0B253A] pt-4">2. How We Use Your Information</h2>
        <p>
        ...
        <h2 className="font-display font-bold text-xl text-[#0B253A] pt-4">3. Data Security</h2>
        <p>
