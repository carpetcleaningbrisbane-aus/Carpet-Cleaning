...
export default function TermsPage() {
  return (
    <div className="pt-24 md:pt-32 pb-24 px-5 md:px-16 max-w-[960px] mx-auto">
      <h1 className="font-display font-bold text-4xl text-[#001b31] mb-6">Terms of Service</h1>
      ...
      <div className="space-y-6 text-sm text-[#43474d] leading-relaxed">
        ...
        <h2 className="font-display font-bold text-xl text-[#001b31] pt-4">2. Satisfaction Guarantee & Re-Cleans</h2>
        <p>
        ...
        <h2 className="font-display font-bold text-xl text-[#001b31] pt-4">3. Cancellations & Rescheduling</h2>
        <p>
